...
export default function UpdateAddress() {
    ...
    return (
        <ScrollView style={styles.container} automaticallyAdjustKeyboardInsets>
            ...
            <TextInput keyboardType="number-pad" autoComplete="tel" style={styles.inputContainer} value={phone} onChangeText={(text) => setPhone(text)} placeholder="Phone" placeholderTextColor={colorPalete.silver} />
