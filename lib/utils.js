...
export const FIREBASE_CLIENT_ID ="654317343091-d8ivg98e41fcfb568ol9tghi6ftr0r25.apps.googleusercontent.com"
const pinAmount = {
  "180 - 194": 120,
  "171 - 177": 120,
  "140 - 160": 120,
...
export const getProductsAndTotal = (cart, products, pin) => {
  ...
  return {
    cart: cartProducts,
    total: total,
    shipping: pin !== "no" ? getShipping(inCartProducts, pin)/2 : 0,
  };
};