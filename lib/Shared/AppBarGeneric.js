...
export default function AppBarGeneric({ title, customAction, disableBackButton }) {
    ...
    return (
        <>
            ...
            <View style={styles.container}>
                {!disableBackButton && <View style={styles.iconWithoutBackground}>
                    <Icon action={runActions} badge={0} name={"arrow-left"} size={26} color={colorPalete.silver_silk} />
                </View>}
